...
_0x0:
	.DB  0x46,0x6B,0x75,0x6C,0x74,0x61,0x73,0x20
	.DB  0x54,0x65,0x6B,0x6E,0x6F,0x6C,0x6F,0x67
	.DB  0x69,0x20,0x49,0x6E,0x64,0x75,0x73,0x74
	.DB  0x72,0x69,0x0,0x55,0x4B,0x4B,0x20,0x4B
	.DB  0x65,0x64,0x69,0x72,0x69,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0079 ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 007A SFIOR=(0<<ACME);
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 007B 
; 0000 007C // ADC initialization
; 0000 007D // ADC disabled
; 0000 007E ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 007F 
...
; 0000 0098       lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0099       lcd_putsf("Fkultas Teknologi Industri");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 009A       lcd_gotoxy(3,1);
	LDI  R30,LOW(3)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 009B       lcd_putsf("UKK Kediri");
	__POINTW2FN _0x0,27
	RCALL _lcd_putsf
; 0000 009C       }
	RJMP _0x3
