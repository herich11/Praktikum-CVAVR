...
; 0000 005F ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0060 TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 008B       	kanan=0;
	...
	CLR  R7
; 0000 008C 
; 0000 008D         for(kiri=0;kiri<2;kiri++)
	CLR  R4
	CLR  R5
_0x8:
	LDI  R30,LOW(2)
	...
	BRGE _0x9
; 0000 008E             {
; 0000 008F                 for(kanan=0;kanan<10;kanan++)
	CLR  R6
	CLR  R7
_0xB:
	LDI  R30,LOW(10)
