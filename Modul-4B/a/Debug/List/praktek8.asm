...
; 0000 002B DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
...
; 0000 008C       kanan=0;
	...
	CLR  R7
; 0000 008D 
; 0000 008E        for(kiri=0;kiri<2;kiri++)
	CLR  R4
	CLR  R5
_0x8:
	LDI  R30,LOW(2)
	...
	BRGE _0x9
; 0000 008F             {
; 0000 0090                 for(kanan=0;kanan<10;kanan++)
	CLR  R6
	CLR  R7
_0xB:
	LDI  R30,LOW(10)
...
; 0000 0095                     PORTA.1=0;
	CBI  0x1B,1
; 0000 0096                     PORTB=bil[kiri];
	LDI  R26,LOW(_bil)
	LDI  R27,HIGH(_bil)
	ADD  R26,R4
	ADC  R27,R5
	RCALL SUBOPT_0x0
; 0000 0097                     delay_ms(5);
; 0000 0098                     PORTA.0=0;
	CBI  0x1B,0
; 0000 0099                     PORTA.1=1;
	SBI  0x1B,1
; 0000 009A                     PORTB=bil[kanan];
	LDI  R26,LOW(_bil)
	LDI  R27,HIGH(_bil)
	ADD  R26,R6
	ADC  R27,R7
