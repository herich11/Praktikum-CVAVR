...
;
;char kiri=9;
;unsigned char kanan=9;  //nilai awal =99
;
;void tampil (void)
; 0000 0021 {
...
; 0000 0027  PORTA=0x01;
	LDI  R30,LOW(1)
	OUT  0x1B,R30
; 0000 0028  PORTB=bil[kiri] ;
	MOV  R30,R5
	RCALL SUBOPT_0x0
; 0000 0029  delay_us(200);
; 0000 002A  PORTA=0x02;
	LDI  R30,LOW(2)
	OUT  0x1B,R30
; 0000 002B  PORTB=bil[kanan]    ;
	MOV  R30,R4
	RCALL SUBOPT_0x0
...
; 0000 008E ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 008F SFIOR=(0<<ACME);
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 0090 
; 0000 0091 // ADC initialization
; 0000 0092 // ADC disabled
; 0000 0093 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 0094 
...
; 0000 00A3     if(kiri==0)
	...
	BRNE _0xE
; 0000 00A4     {
; 0000 00A5         kanan=9; kiri=9;
	LDI  R30,LOW(9)
	MOV  R4,R30
	MOV  R5,R30
; 0000 00A6     }
; 0000 00A7     else if(kiri>=1)
	RJMP _0xF
_0xE:
	LDI  R30,LOW(1)
	CP   R5,R30
...
; 0000 00A9         kanan=9;
	LDI  R30,LOW(9)
	MOV  R4,R30
; 0000 00AA         kiri=kiri-1;
	DEC  R5
; 0000 00AB     }
; 0000 00AC    }
_0x10:
_0xF:
; 0000 00AD    else if(kanan>=1)
	RJMP _0x11
_0xD:
	LDI  R30,LOW(1)
	CP   R4,R30
