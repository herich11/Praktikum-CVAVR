...
; 0000 0063 // Clock value: 250.000 kHz
; 0000 0064 // Mode: Fast PWM top=0x00FF
; 0000 0065 // OC1A output: Non-Inverted PWM
; 0000 0066 // OC1B output: Non-Inverted PWM
; 0000 0067 // Noise Canceler: Off
; 0000 0068 // Input Capture on Falling Edge
; 0000 0069 // Timer Period: 1.024 ms
; 0000 006A // Output Pulse(s):
; 0000 006B // OC1A Period: 1.024 ms Width: 0 us// OC1B Period: 1.024 ms Width: 0 us
...
; 0000 0070 TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(161)
	OUT  0x2F,R30
; 0000 0071 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (1<<CS11) | (1<<CS10);
	LDI  R30,LOW(11)
	OUT  0x2E,R30
...
; 0000 00AE       kirplus=1;kirmin=0;
	SBI  0x12,1
	CBI  0x12,2
; 0000 00AF       lpwm=0;rpwm=0;
	LDI  R30,LOW(0)
	LDI  R31,HIGH(0)
	OUT  0x28+1,R31
	OUT  0x28,R30
	OUT  0x2A+1,R31
	OUT  0x2A,R30
; 0000 00B0       delay_ms(5800);
	LDI  R26,LOW(5800)
	LDI  R27,HIGH(5800)
	RCALL _delay_ms
; 0000 00B1       kirplus=0;kirmin=1;
	CBI  0x12,1
	SBI  0x12,2
; 0000 00B2       lpwm=250;rpwm=250;
	LDI  R30,LOW(250)
	LDI  R31,HIGH(250)
	OUT  0x28+1,R31
	OUT  0x28,R30
