...
; 0000 0022 {
	...
	.CSEG
; 0000 0023 kirplus=1;  kanplus=1;
; 0000 0024 kirmin=0;   kanmin=0;
; 0000 0025 }
;void mundur()
; 0000 0027 {
; 0000 0028 kirplus=0;  kanplus=0;
; 0000 0029 kirmin=1;   kanmin=1;
; 0000 002A }
;void belok_kanan()
; 0000 002C {
; 0000 002D kirplus=1;  kanplus=0;
; 0000 002E kirmin=0;   kanmin=1;
; 0000 002F }
;void belok_kiri()
; 0000 0031 {
; 0000 0032 kirplus=0;  kanplus=1;
; 0000 0033 kirmin=1;   kanmin=0;
; 0000 0034 }
;void stop()
; 0000 0036 {
; 0000 0037 kirplus=0;  kanplus=0;
; 0000 0038 kirmin=0;   kanmin=0;
; 0000 0039 }
;void main(void)
; 0000 003B {
_main:
...
; 0000 0064 // OC1A output: Non-Inverted PWM
; 0000 0065 // OC1B output: Non-Inverted PWM
; 0000 0066 // Noise Canceler: Off
; 0000 0067 // Input Capture on Falling Edge
; 0000 0068 // Timer Period: 1.024 ms
; 0000 0069 // Output Pulse(s):
; 0000 006A // OC1A Period: 1.024 ms Width: 0 us// OC1B Period: 1.024 ms Width: 0 us
...
; 0000 006F TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(161)
	OUT  0x2F,R30
; 0000 0070 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (1<<CS11) | (1<<CS10);
	LDI  R30,LOW(11)
	OUT  0x2E,R30
...
; 0000 007F ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0080 TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 00AD       kirplus=1;kirmin=0;
	SBI  0x12,1
	CBI  0x12,2
; 0000 00AE       lpwm=0;rpwm=0;
	LDI  R30,LOW(0)
	LDI  R31,HIGH(0)
	OUT  0x28+1,R31
	OUT  0x28,R30
	OUT  0x2A+1,R31
	OUT  0x2A,R30
; 0000 00AF       delay_ms(2900);
	LDI  R26,LOW(2900)
	LDI  R27,HIGH(2900)
	RCALL _delay_ms
; 0000 00B0       kirplus=0;kirmin=1;
	CBI  0x12,1
	SBI  0x12,2
; 0000 00B1       lpwm=250;rpwm=250;
	LDI  R30,LOW(250)
	LDI  R31,HIGH(250)
	OUT  0x28+1,R31
	OUT  0x28,R30
