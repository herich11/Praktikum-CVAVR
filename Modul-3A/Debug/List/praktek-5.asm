...
_0x4:
	.DB  0xF7,0xBF,0xDF,0xEF,0xF7,0xFB,0xFD,0xFE
...
;char dataLED1[8]={0xFE,0xFD,0xFB,0xF7,0xEF,0xDF,0xBF,0x7F};

	.DSEG
;char dataLED2[8]={0xF7,0xBF,0xDF,0xEF,0xF7,0xFB,0xFD,0xFE};
;char i;
;char j;
;
; void lampu1()
...
_0x9:
	...
	BRSH _0xA
; 0000 0025             {
; 0000 0026             PORTA=dataLED1[i];
	MOV  R30,R5
	LDI  R31,0
	SUBI R30,LOW(-_dataLED1)
	SBCI R31,HIGH(-_dataLED1)
	RCALL SUBOPT_0x0
...
_0xF:
	...
	BRSH _0x10
; 0000 0031             {
; 0000 0032             PORTA=dataLED2[i];
	MOV  R30,R5
	LDI  R31,0
	SUBI R30,LOW(-_dataLED2)
	SBCI R31,HIGH(-_dataLED2)
	RCALL SUBOPT_0x0
