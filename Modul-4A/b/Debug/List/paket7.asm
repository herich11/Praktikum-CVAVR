...
_0x0:
	.DB  0x53,0x69,0x6C,0x61,0x68,0x6B,0x61,0x6E
	.DB  0x20,0x74,0x65,0x6B,0x61,0x6E,0x20,0x74
	.DB  0x6F,0x6D,0x62,0x6F,0x6C,0x0,0x54,0x6F
	.DB  0x6D,0x62,0x6F,0x6C,0x20,0x30,0x0,0x20
...
; 0000 0061 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0062 TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 009B 		lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 009C 		lcd_putsf("Silahkan tekan tombol");
	__POINTW2FN _0x0,0
	RCALL SUBOPT_0x1
; 0000 009D 		delay_ms(10);
; 0000 009E 		}
; 0000 009F 	else if(PINB.0==1)
	RJMP _0x7
_0x6:
	SBIS 0x16,0
	RJMP _0x8
