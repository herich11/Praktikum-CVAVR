...
_0x0:
	.DB  0x4D,0x61,0x68,0x61,0x73,0x69,0x73,0x77
	.DB  0x61,0x0,0x46,0x54,0x49,0x0,0x20,0x20
...
; 0000 009B         lcd_gotoxy(0,1);
	RCALL SUBOPT_0x0
; 0000 009C         lcd_putsf("Mahasiswa");
	__POINTW2FN _0x0,0
	RCALL SUBOPT_0x1
; 0000 009D         delay_ms(10);
; 0000 009E         }
; 0000 009F       else if (PINB.1==0)
	RJMP _0x7
_0x6:
	SBIC 0x16,1
	RJMP _0x8
; 0000 00A0         {
; 0000 00A1         lcd_gotoxy(10,1);
	LDI  R30,LOW(10)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 00A2         lcd_putsf("FTI");
	__POINTW2FN _0x0,10
	RCALL SUBOPT_0x1
