...
_keypad:
; .FSTART _keypad
; 0000 001F PORTB = 0b11111110;    //aktifkan baris1 (memberi logika 0 ke baris1)
	LDI  R30,LOW(254)
	RCALL SUBOPT_0x0
; 0000 0020 delay_ms(100);
; 0000 0021 if(PINB.7==0) return (10); if(PINB.6==0) return (3); if(PINB.5==0) return (2); if(PINB.4==0) return (1);
	SBIC 0x16,7
	RJMP _0x4
	LDI  R30,LOW(10)
	RET
...
_0x6:
	...
	RET
; 0000 0022 //========================
; 0000 0023 PORTB = 0b11111101;//aktifkan baris2
_0x7:
	LDI  R30,LOW(253)
	RCALL SUBOPT_0x0
; 0000 0024 delay_ms(100);
; 0000 0025 if(PINB.7==0) return (11); if(PINB.6==0) return (6); if(PINB.5==0) return (5); if(PINB.4==0) return (4);
	SBIC 0x16,7
	RJMP _0x8
	LDI  R30,LOW(11)
	RET
...
_0xA:
	...
	RET
; 0000 0026 //========================
; 0000 0027 PORTB = 0b11111011; //aktifkan baris3
_0xB:
	LDI  R30,LOW(251)
	RCALL SUBOPT_0x0
; 0000 0028 delay_ms(100);
; 0000 0029 if(PINB.7==0) return (12); if(PINB.6==0) return (9); if(PINB.5==0) return (8); if(PINB.4==0) return (7);
	SBIC 0x16,7
	RJMP _0xC
	LDI  R30,LOW(12)
	RET
...
_0xE:
	...
	RET
; 0000 002A //========================
; 0000 002B PORTB = 0b11110111; //aktifkan baris4
_0xF:
	LDI  R30,LOW(247)
	RCALL SUBOPT_0x0
; 0000 002C delay_ms(100);
; 0000 002D if(PINB.7==0) return (13);
	SBIC 0x16,7
	RJMP _0x10
	LDI  R30,LOW(13)
	RET
; 0000 002E if(PINB.6==0) return (15); if(PINB.5==0) return (0); if(PINB.4==0) return (14);
_0x10:
	SBIC 0x16,6
	RJMP _0x11
	LDI  R30,LOW(15)
...
; 0000 00AE       {
; 0000 00AF       if (langkah==1){
	LD   R26,Y
	LDD  R27,Y+1
	SBIW R26,1
	BRNE _0x17
; 0000 00B0       one=keypad();
	RCALL _keypad
	MOV  R20,R30
	CLR  R21
; 0000 00B1       langkah=2;
	...
	STD  Y+1,R31
; 0000 00B2 }
; 0000 00B3       if (langkah==2){
_0x17:
	LD   R26,Y
	LDD  R27,Y+1
	SBIW R26,2
	BRNE _0x18
; 0000 00B4       two=keypad();
	RCALL _keypad
	LDI  R31,0
	STD  Y+4,R30
	STD  Y+4+1,R31
; 0000 00B5 }
; 0000 00B6         if (one>50){ goto x;
_0x18:
	__CPWRN 20,21,51
	BRLT _0x1C
; 0000 00B7         }
; 0000 00B8         else  { goto y;
; 0000 00B9         }
; 0000 00BA       // Place your code here
; 0000 00BB 
; 0000 00BC 
; 0000 00BD //untuk counter up
; 0000 00BE  x:
_0x1A:
; 0000 00BF       satu=0;
	__GETWRN 16,17,0
; 0000 00C0       dua=0;
	__GETWRN 18,19,0
; 0000 00C1 for (satu=0;satu<10;satu++)
	__GETWRN 16,17,0
_0x1E:
	__CPWRN 16,17,10
	BRGE _0x1F
; 0000 00C2 {
; 0000 00C3 for (dua=0;dua<10;dua++)
	__GETWRN 18,19,0
_0x21:
	__CPWRN 18,19,10
	BRGE _0x22
; 0000 00C4 {
; 0000 00C5      for (t=1;t<100;t++)
	RCALL SUBOPT_0x1
_0x24:
	RCALL SUBOPT_0x2
	BRGE _0x25
; 0000 00C6      if(satu==9&dua==9)
	RCALL SUBOPT_0x3
	BRNE _0x1A
; 0000 00C7 
; 0000 00C8      goto x;
...
; 0000 00CB                 PORTC.7=1;
	RCALL SUBOPT_0x4
; 0000 00CC                 PORTC.6=0;
; 0000 00CD                 PORTD=bil[dua];
; 0000 00CE                 delay_ms(1);
; 0000 00CF 
; 0000 00D0                 PORTC.7=0;
; 0000 00D1                 PORTC.6=1;
; 0000 00D2                 PORTD=bil[satu];
; 0000 00D3                 delay_ms(1);
; 0000 00D4 
; 0000 00D5 
; 0000 00D6 //untuk counter down
; 0000 00D7 y:
_0x1C:
; 0000 00D8 for (satu=9;satu>=0;satu--)
	__GETWRN 16,17,9
_0x31:
	TST  R17
	BRMI _0x32
; 0000 00D9 {
; 0000 00DA for (dua=9;dua>0;dua--)
	__GETWRN 18,19,9
_0x34:
	CLR  R0
	CP   R0,R18
	...
	BRGE _0x35
; 0000 00DB {
; 0000 00DC          for (t=1;t<100;t++)
	RCALL SUBOPT_0x1
_0x37:
	RCALL SUBOPT_0x2
	BRGE _0x38
; 0000 00DD          if(satu==9&dua==9)
	RCALL SUBOPT_0x3
	BRNE _0x1A
; 0000 00DE          goto x;
; 0000 00DF          else
...
; 0000 00E1                 PORTC.7=1;
	RCALL SUBOPT_0x4
; 0000 00E2                 PORTC.6=0;
; 0000 00E3                 PORTD=bil[dua];
; 0000 00E4                 delay_ms(1);
; 0000 00E5 
; 0000 00E6                 PORTC.7=0;
; 0000 00E7                 PORTC.6=1;
; 0000 00E8                 PORTD=bil[satu];
