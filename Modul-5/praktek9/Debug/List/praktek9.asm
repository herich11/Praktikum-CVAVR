...
; 0000 001E             PORTB.4=0;
	CBI  0x18,4
; 0000 001F             dt=(~PINB & 0x0F);
	RCALL SUBOPT_0x0
; 0000 0020             switch (dt)
; 0000 0021                {
; 0000 0022                case 1 : dtkey=0b11111001;
	BRNE _0x8
	LDI  R30,LOW(249)
	RJMP _0x2C
; 0000 0023 
; 0000 0024                break;
; 0000 0025 
; 0000 0026                case 2 : dtkey=0b11111111;
_0x8:
	RCALL SUBOPT_0x1
	BREQ _0x2D
; 0000 0027 
; 0000 0028                break;
; 0000 0029 
; 0000 002A                case 4 : dtkey=0b11111111;
	RCALL SUBOPT_0x2
	BREQ _0x2D
; 0000 002B 
; 0000 002C                break;
; 0000 002D 
; 0000 002E                case 8 : dtkey=0b11111111;
	RCALL SUBOPT_0x3
	BRNE _0x7
_0x2D:
	LDI  R30,LOW(255)
...
; 0000 0034                PORTB.5=0;
	CBI  0x18,5
; 0000 0035                 dt=(~PINB & 0x0F);
	RCALL SUBOPT_0x0
; 0000 0036                switch (dt)
; 0000 0037                {
; 0000 0038                case 1 : dtkey=0b11111111;
	BREQ _0x2E
; 0000 0039 
; 0000 003A                break;
; 0000 003B 
; 0000 003C                case 2 : dtkey=0b10010010;
	RCALL SUBOPT_0x1
	BRNE _0x14
	LDI  R30,LOW(146)
	RJMP _0x2F
...
; 0000 003E                break;
; 0000 003F 
; 0000 0040                case 4 : dtkey=0b11111111;
_0x14:
	RCALL SUBOPT_0x2
	BREQ _0x2E
; 0000 0041 
; 0000 0042                break;
; 0000 0043 
; 0000 0044                case 8 : dtkey=0b11111111;
	RCALL SUBOPT_0x3
	BRNE _0x12
_0x2E:
	LDI  R30,LOW(255)
...
; 0000 004A                PORTB.6=0;
	CBI  0x18,6
; 0000 004B                 dt=(~PINB & 0x0F);
	RCALL SUBOPT_0x0
; 0000 004C                switch (dt)
; 0000 004D                {
; 0000 004E                case 1 : dtkey=0b11111111;
	BREQ _0x30
; 0000 004F 
; 0000 0050                break;
; 0000 0051 
; 0000 0052                case 2 : dtkey=0b11111111;
	RCALL SUBOPT_0x1
	BREQ _0x30
; 0000 0053 
; 0000 0054                break;
; 0000 0055 
; 0000 0056                case 4 : dtkey=0b10010000;
	RCALL SUBOPT_0x2
	BRNE _0x20
	LDI  R30,LOW(144)
	RJMP _0x31
...
; 0000 0058                break;
; 0000 0059 
; 0000 005A                case 8 : dtkey=0b11111111;
_0x20:
	RCALL SUBOPT_0x3
	BRNE _0x1D
_0x30:
...
; 0000 006E DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
...
; 0000 0074 DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(255)
	OUT  0x14,R30
...
; 0000 007A DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(255)
	OUT  0x11,R30
...
; 0000 00A3 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 00A4 TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 00D0       PORTC.7=0;
	CBI  0x15,7
; 0000 00D1       PORTD=dtkey;
	OUT  0x12,R4
; 0000 00D2       delay_ms(5);
	LDI  R26,LOW(5)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00D3       }
